...
## [2026-04-10] note | 引入 Domain Types 架构
新增两种领域预设：**AI Tracking**（动态追踪型，当前 ai-research）和 **Academic Research**（学术研究型）。新增页面类型：method / debate / gap。新增目录：wiki/methods/、wiki/debates/、wiki/gaps/。更新 CLAUDE.md（Domain Types 节、method/debate/gap 格式、Academic Research ingest 流程）、wiki/index.md（Methods / Debates / Gaps 分节）。
